...
class UploadSinf extends StatefulWidget {

  final String? sinf;
  final String? tili;
  const UploadSinf({Key? key, this.sinf, this.tili}) : super(key: key);

  @override
  State<UploadSinf> createState() => _UploadSinfState();
}

class _UploadSinfState extends State<UploadSinf> {
                    ...
                    children: [
                      ...
                      CupertinoButton(
                        onPressed: () async {
                          ...
                          if("${widget.tili}"=="Maktab Darsliklari"){
                            createBooksinf(name: name,sinf: widget.sinf,imgDownload: imgDownload,pdfDownload: pdfDownload,tili: widget.tili);
                          } else if("${widget.tili}"=="Учебники") {
                            createBooksinf(name: name,sinf: widget.sinf,imgDownload: imgDownload,pdfDownload: pdfDownload,tili: widget.tili);
                          } else{
