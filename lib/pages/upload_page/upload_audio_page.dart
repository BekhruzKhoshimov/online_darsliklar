...
//   final String? apbar;
//
//   const UploadAudio({Key? key, this.sinf, this.tili, this.apbar}) : super(key: key);
//
//   @override
...
//     final fileName = file != null ? (file!.path) : "No Audio Selected";
//     return Scaffold(
//         appBar: AppBar(
//           backgroundColor: Colors.white,
//           title: Text("${widget.sinf}larga Audio Kitob yuklash",style: const TextStyle(color: Colors.black),),
//           centerTitle: true,
//           leading: IconButton(
//             onPressed: (){
...
//                           createAudio(name: name,sinf: widget.sinf,imgDownload: imgDownload,pdfDownload: pdfDownload,apbar: widget.apbar);
//                           print("////////////////////////// ${widget.apbar} //////////////////////////////////////////////");
//                         },
//                         child: Container(
//                           height: 70,
